...
import "./Info.css"
function InfoStageEtudiant(){

    return (
        <div className="contenu-info">
            <div className="contenu-info__texte">
                <h1>Déroulement des stages (Etudiants)</h1>
                <p>
                    ...
                    Tâches à effectuer par l'étudiant à la session d'automne  (c'est-à-dire maintenant):
                        ...
                        <li>
                            ...
                            Contacter les employeurs pour leur proposer vos services<br/>
                            
                            Pour chaque employeur que vous contactez vous devez inscrire ses coordonnées sur le <a href="../documents/contact_employeurs.pdf">formulaire</a><br/>
                    ...
                    <p styles="text-align: left">Plus de détails pour les 
...
export default InfoStageEtudiant;